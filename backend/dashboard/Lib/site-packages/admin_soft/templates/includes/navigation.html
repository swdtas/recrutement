{% load static %}
<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow- border-radius-xl " id="navbarBlur" navbar-scroll="">
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
        <li class="text-sm text-dark active ms-2" aria-current="page">
          {% if request.path == '/' %} / Tableau de bord {% else %} {{ request.path|title }} {% endif %}
        </li>
      </ol>
    </nav>
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
      ...
      <ul class="navbar-nav  justify-content-end">
        ...
        {% if request.user.is_authenticated %}
          <li class="nav-item d-flex align-items-center">
            ...
            {% endif %}
              ...
              <span class="d-sm-inline d-none me-3">Déconnexion</span>
            </a>
          </li>
        {% else %}
          <li class="nav-item d-flex align-items-center">
            <a href="{% url 'login' %}" class="nav-link text-body font-weight-bold px-0">
              <i class="fa fa-user me-sm-1"></i>
              <span class="d-sm-inline d-none me-3">Se connecter</span>
            </a>
          </li>
        {% endif %}
        ...
        <li class="nav-item d-flex align-items-center">
          ...
          {% endif %}
            <span class="d-sm-inline d-none me-3">changer le mot de passe</span>
          </a>
        </li>
